...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default='model_788', type=str, help="Network model to load.")
    ...
    network.load('car_racing/' + args.model)
    ...
    for episode in range(100):
        ...
        while not done:
            ...
            q_values = network.predict([buffer.popleft()], [state])[0]
